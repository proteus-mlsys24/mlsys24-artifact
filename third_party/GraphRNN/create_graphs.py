...
### load datasets
    ...
    elif args.graph_type in ["onnx", "onnx_larger", "onnx_larger_2", "onnx_new", "onnx_new_larger"]:
        path_name = {
            "onnx": "/home/ybgao/research/Private-Compiler/adversary/generative/graphrnn_scripts/saved_graphs/*.pkl",
            "onnx_larger": "/home/ybgao/research/Private-Compiler/adversary/generative/graphrnn_scripts/saved_graphs_larger/*.pkl",
            "onnx_larger_2": "/home/ybgao/research/Private-Compiler/adversary/generative/graphrnn_scripts/saved_graphs_larger_2/*.pkl",

            "onnx_new": "/home/ybgao/research/Private-Compiler/private-compiler/private_compiler/data/datasets/real_*.pkl",
            "onnx_new_larger": "/home/ybgao/research/Private-Compiler/private-compiler/private_compiler/data/datasets/onnx_new_larger/real_*.pkl"
        }[args.graph_type]

        graphs = []
        for filename in glob(path_name):
            with open(filename, "rb") as fp:
                if args.graph_type not in ["onnx_new", "onnx_new_larger"]:
                    tmp_graphs = pickle.load(fp)
                    graphs.extend(tmp_graphs)
                else:
                    tmp_graphs = pickle.load(fp)
                    for f, ps in tmp_graphs:
                        graphs.extend(ps)

        print(f"Loaded {len(graphs)} graphs from {args.graph_type}.")
